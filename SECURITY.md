...
4. We will notify the reporter about the fix, acknowledge their contribution
  in the release notes and on our website, if they wish to be credited.

## Bug Bounty Program

OpenAtlas does not currently operate a bug bounty program. We do not offer
monetary rewards for vulnerability reports.

We appreciate responsible disclosure and will acknowledge contributors in our
release notes and on our website (with permission), but submitting a report
does not guarantee or imply any monetary compensation.
