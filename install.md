...
Run the tests against a local OpenAtlas instance:
    ...
    schemathesis run openatlas/api/openapi.json \
        --url=https://demo-dev.openatlas.eu/api/ \
        --workers=1 \
        --exclude-path-regex="(export_database|table_rows|latest|query|cidoc_class|entities_linked_to_entity|system_class|type_entities|type_entities_all|view_class|linked_entities_by_properties_recursive)"
