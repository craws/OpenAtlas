...
def populate_dates(form: FlaskForm, item: Union[Entity, Link]) -> None:
    if item.begin_from:
        ...
        form.begin_hour_from.data = format_date_part(item.begin_from, 'hour')
        form.begin_minute_from.data = format_date_part(
            item.begin_from, 'minute')
        form.begin_second_from.data = format_date_part(
            item.begin_from, 'second')
        ...
        if item.begin_to:
            ...
            form.begin_hour_to.data = format_date_part(item.begin_to, 'hour')
            form.begin_minute_to.data = format_date_part(
                item.begin_to, 'minute')
            form.begin_second_to.data = format_date_part(
                item.begin_to, 'second')
    if item.end_from:
        ...
        form.end_minute_from.data = format_date_part(
            item.end_from, 'minute')
        form.end_second_from.data = format_date_part(
            item.end_from, 'second')
        ...
        if item.end_to:
            ...
            form.end_minute_to.data = format_date_part(
                item.end_to, 'minute')
            form.end_second_to.data = format_date_part(
                item.end_to, 'second')
