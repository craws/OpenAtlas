...
mapInputForm.onAdd = () => {
    ...
    <div class="mapFormDiv" onmouseover="interactionOff()" 
      onmouseout="interactionOn()">
            ...
            <input type="text" id="nameField" class="form-control form-control-sm" 
              placeholder="${translate["map_info_name"]}">
            <textarea rows="3" cols="70" id="descriptionField"  class="form-control form-control-sm"
            ...
            <div class="markerInput">
                ...
                <input type="text" oninput="check_coordinates_input_marker()" class="form-control form-control-sm"
            ...
            <div class="polygonInput">
                ...
                <input type="text" oninput="check_coordinates_input_polygon()" class="form-control form-control-sm"
