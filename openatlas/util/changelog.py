versions = {
    ...
    '3.0.0': ['2017-12-31', {
        'feature': {
            ...
            <p>
                This version includes many new features and changes. Some are 
                listed below.
            </p>
    ...
    '0.10.0': ['2015-09-01', {
        'feature': {
            ...
            '489':
                'Layout - overwork, multiple possibilities to create and link '
                'entities',
    ...
    '0.0.1': ['2014-11-05', {
        'feature': {
            '':
                'Initial version based on the "Zend Base" project from <a '
