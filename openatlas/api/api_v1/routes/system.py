...
from openatlas.api.api_v1.models.system import \
    EntityStatsQuery, EntityStatsResponse, LicensedFileOverviewQuery, \
    LicensedFileOverviewResponse,SystemClassesResponse, SystemInfoResponse, MapConfig, ImageProcessingInfo, IiifInfo, MapConfig, ImageProcessingInfo, IiifInfo,\
    SystemPropertiesResponse, SystemTypeTreeResponse, SystemTypesResponse
...
def get_system_info() -> dict:
    ...
    return SystemInfoResponse(
        ...
        logo_file_id=int(g.settings['logo_file_id']) if g.settings.get('logo_file_id') else None,
        default_language=g.settings['default_language'],
        module_time=g.settings.get('module_time', False) in (True, 'True', '1', 1),
        ...
        iiif=IiifInfo(
            ...
            version=str(g.settings['iiif_version']) if g.settings.get('iiif_version') else None
        )
