...
def invalid_system_class(e: Exception):
    return jsonify({
...
def invalid_view_class(e: Exception):
    return jsonify({
...
def no_search_string(e: Exception):
    return jsonify({
...
def one_id_is_not_a_type(e: Exception):
    return jsonify({
