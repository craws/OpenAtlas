...
burial) and the back filling. Each stratigraphic unit may have associated finds (:doc:`artifact`) belonging to the
respective unit: e.g. the grave goods of one of the burials, the finds found in the back filling. Anthropological information
