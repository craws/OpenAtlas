...
When logged in you can access your **profile** at the right top of the site.
There you can edit personal information and adapt the user interface to your
preferences.

Change password
---------------
When clicking on **Change password** you have to enter the current password and
a new one twice.
...
e.g. existing sub units even when you deactivate them but the interface elements
...
* **Show created and modified information** - show when/by whom an entry was
  created/updated
* **Show import information** - show original project and identifier at entities
  that were imported from another project
* **Show CIDOC class** - show the corresponding CIDOC class at entity view
* **Show API links** - show a buttons for :doc:`/tools/api` views at entities
* **Default map zoom** - define the lowest zoom level to include all features in
  a :doc:`/tools/map` view
