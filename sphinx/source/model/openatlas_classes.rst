...
All OpenAtlas classes can be mapped directly to the corresponding CIDOC CRM classes. For all available classes and properties of CIDOC CRM (version 7.1.1) see here.
