...
* Click on :doc:`/entity/artifact` in the menu and create a new entry by using the '+ Artifact' button
...
* Click on the 'Artifact' button and choose the before created letter from the list
* Press 'Insert' to save the entry
