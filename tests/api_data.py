...
api_code_reference = {'results': [{'@context': 'https://raw.githubusercontent.com/LinkedPasts/linked-places/master/linkedplaces-context-v1.1.jsonld', 'type': 'FeatureCollection', 'features': [{'@id': 'http://local.host/entity/107', 'type': 'Feature', 'crmClass': 'crm:E31 Document', 'systemClass': 'external_reference', 'properties': {'title': 'https://openatlas.eu'}, 'description': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}, 'types': None, 'relations': [{'label': 'Nostromos', 'relationTo': 'http://local.host/api/0.2/entity/104', 'relationType': 'crm:P67 refers to', 'relationSystemClass': 'place', 'type': None, 'when': {'timespans': [{'start': {'earliest': '2018-01-31', 'latest': '2018-03-01'}, 'end': {'earliest': '2019-01-31', 'latest': '2019-03-01'}}]}}], 'names': None, 'links': None, 'geometry': None, 'depictions': None}]}], 'pagination': {'entities': 1, 'entitiesPerPage': 20, 'index': [{'page': 1, 'startId': 107}], 'totalPages': 1}}

api_code_reference_geojson = {'results': [{'type': 'FeatureCollection', 'features': [{'type': 'Feature', 'geometry': None, 'properties': [{'@id': 107, 'systemClass': 'external_reference', 'name': 'https://openatlas.eu', 'description': None, 'begin_earliest': None, 'begin_latest': None, 'begin_comment': None, 'end_earliest': None, 'end_latest': None, 'end_comment': None, 'types': None}]}]}], 'pagination': {'entities': 1, 'entitiesPerPage': 20, 'index': [{'page': 1, 'startId': 107}], 'totalPages': 1}}

api_code_place_first_sort_show_limit = {'results': [{'@context': 'https://raw.githubusercontent.com/LinkedPasts/linked-places/master/linkedplaces-context-v1.1.jsonld', 'type': 'FeatureCollection', 'features': [{'@id': 'http://local.host/entity/108', 'type': 'Feature', 'crmClass': 'crm:E18 Physical Thing', 'systemClass': 'feature', 'properties': {'title': 'Feature'}, 'description': None, 'geometry': {'type': 'GeometryCollection', 'geometries': []}}]}], 'pagination': {'entities': 3, 'entitiesPerPage': 2, 'index': [{'page': 1, 'startId': 110}, {'page': 2, 'startId': 108}], 'totalPages': 2}}
