...
api_code_reference_geojson = {'results': [{'type': 'FeatureCollection', 'features': [
    {'type': 'Feature', 'geometry': None, 'properties': [
        {'@id': 107, 'systemClass': 'external_reference', 'name': 'https://openatlas.eu',
         'description': None, 'begin_earliest': None, 'begin_latest': None, 'begin_comment': None,
         'end_earliest': None, 'end_latest': None, 'end_comment': None, 'types': None}]}]}],
                              'pagination': {'entities': 1, 'entitiesPerPage': 20,
...
api_code_place_filter_time = {'results': [{'@context': 'https://raw.githubusercontent.com/LinkedPasts/linked-places/master/linkedplaces-context-v1.1.jsonld', 'type': 'FeatureCollection', 'features': [{'@id': 'http://local.host/entity/108', 'type': 'Feature', 'crmClass': 'crm:E18 Physical Thing', 'systemClass': 'feature', 'properties': {'title': 'Feature'}, 'description': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}, 'types': None, 'relations': [{'label': 'Location of Feature', 'relationTo': 'http://local.host/api/0.2/entity/109', 'relationType': 'crm:P53 has former or current location', 'relationSystemClass': 'object_location', 'type': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}}, {'label': 'Strato', 'relationTo': 'http://local.host/api/0.2/entity/110', 'relationType': 'crm:P46 is composed of', 'relationSystemClass': 'stratigraphic_unit', 'type': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}}, {'label': 'Nostromos', 'relationTo': 'http://local.host/api/0.2/entity/104', 'relationType': 'crm:P46i forms part of', 'relationSystemClass': 'place', 'type': None, 'when': {'timespans': [{'start': {'earliest': '2018-01-31', 'latest': '2018-03-01'}, 'end': {'earliest': '2019-01-31', 'latest': '2019-03-01'}}]}}], 'names': None, 'links': None, 'geometry': {'type': 'GeometryCollection', 'geometries': []}, 'depictions': None}]}, {'@context': 'https://raw.githubusercontent.com/LinkedPasts/linked-places/master/linkedplaces-context-v1.1.jsonld', 'type': 'FeatureCollection', 'features': [{'@id': 'http://local.host/entity/104', 'type': 'Feature', 'crmClass': 'crm:E18 Physical Thing', 'systemClass': 'place', 'properties': {'title': 'Nostromos'}, 'description': [{'value': 'That is the Nostromos'}], 'when': {'timespans': [{'start': {'earliest': '2018-01-31', 'latest': '2018-03-01'}, 'end': {'earliest': '2019-01-31', 'latest': '2019-03-01'}}]}, 'types': [{'identifier': 'http://local.host/api/0.2/entity/65', 'label': 'Place', 'description': None, 'hierarchy': '', 'value': None, 'unit': None}, {'identifier': 'http://local.host/api/0.2/entity/102', 'label': 'Height', 'description': None, 'hierarchy': 'Dimensions', 'value': 23.0, 'unit': 'centimeter'}], 'relations': [{'label': 'Cargo hauler', 'relationTo': 'http://local.host/api/0.2/entity/106', 'relationType': 'crm:P1 is identified by', 'relationSystemClass': 'appellation', 'type': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}}, {'label': 'Feature', 'relationTo': 'http://local.host/api/0.2/entity/108', 'relationType': 'crm:P46 is composed of', 'relationSystemClass': 'feature', 'type': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}}, {'label': 'Height', 'relationTo': 'http://local.host/api/0.2/entity/102', 'relationType': 'crm:P2 has type', 'relationSystemClass': 'type', 'type': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}}, {'label': 'Location of Nostromos', 'relationTo': 'http://local.host/api/0.2/entity/105', 'relationType': 'crm:P53 has former or current location', 'relationSystemClass': 'object_location', 'type': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}}, {'label': 'Place', 'relationTo': 'http://local.host/api/0.2/entity/65', 'relationType': 'crm:P2 has type', 'relationSystemClass': 'type', 'type': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}}, {'label': 'Datei', 'relationTo': 'http://local.host/api/0.2/entity/112', 'relationType': 'crm:P67i is referred to by', 'relationSystemClass': 'file', 'type': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}}, {'label': 'GeoNames', 'relationTo': 'http://local.host/api/0.2/entity/1', 'relationType': 'crm:P67i is referred to by', 'relationSystemClass': 'reference_system', 'type': 'close match', 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}}, {'label': 'https://openatlas.eu', 'relationTo': 'http://local.host/api/0.2/entity/107', 'relationType': 'crm:P67i is referred to by', 'relationSystemClass': 'external_reference', 'type': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}}], 'names': [{'alias': 'Cargo hauler'}], 'links': [{'type': 'close match', 'identifier': 'https://www.geonames.org/2761369', 'referenceSystem': 'GeoNames'}], 'geometry': {'type': 'Point', 'coordinates': [9, 17], 'title': '', 'description': ''}, 'depictions': [{'@id': 'http://local.host/api/0.2/entity/112', 'title': 'Datei', 'license': 'Open license', 'url': 'N/A'}]}]}, {'@context': 'https://raw.githubusercontent.com/LinkedPasts/linked-places/master/linkedplaces-context-v1.1.jsonld', 'type': 'FeatureCollection', 'features': [{'@id': 'http://local.host/entity/110', 'type': 'Feature', 'crmClass': 'crm:E18 Physical Thing', 'systemClass': 'stratigraphic_unit', 'properties': {'title': 'Strato'}, 'description': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}, 'types': None, 'relations': [{'label': 'Location of Strato', 'relationTo': 'http://local.host/api/0.2/entity/111', 'relationType': 'crm:P53 has former or current location', 'relationSystemClass': 'object_location', 'type': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}}, {'label': 'Feature', 'relationTo': 'http://local.host/api/0.2/entity/108', 'relationType': 'crm:P46i forms part of', 'relationSystemClass': 'feature', 'type': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}}], 'names': None, 'links': None, 'geometry': {'type': 'GeometryCollection', 'geometries': []}, 'depictions': None}]}], 'pagination': {'entities': 3, 'entitiesPerPage': 20, 'index': [{'page': 1, 'startId': 108}], 'totalPages': 1}}
