...
api_code_reference = {'results': [{'@context': 'https://raw.githubusercontent.com/LinkedPasts/linked-places/master/linkedplaces-context-v1.1.jsonld', 'type': 'FeatureCollection', 'features': [{'@id': 'http://local.host/entity/107', 'type': 'Feature', 'crmClass': 'crm:E31 Document', 'systemClass': 'external_reference', 'properties': {'title': 'https://openatlas.eu'}, 'description': None, 'when': {'timespans': [{'start': {'earliest': None, 'latest': None}, 'end': {'earliest': None, 'latest': None}}]}, 'types': None, 'relations': None, 'names': None, 'links': None, 'geometry': None, 'depictions': None}]}], 'pagination': {'entities': 1, 'entitiesPerPage': 20, 'index': [{'page': 1, 'startId': 107}], 'totalPages': 1}}
