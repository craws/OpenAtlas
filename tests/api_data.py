    ...
    'results': [
        {
            ...
            {'@id': 'http://local.host/entity/107', 'type': 'Feature',
             ...
             'description': None, 'when': {'timespans': [
                {'start': {'earliest': 'None', 'latest': 'None'},
                 'end': {'earliest': 'None', 'latest': 'None'}}]},
             'types': None, 'relations': [{'label': 'Nostromos',
                                           'relationTo': 'http://local.host/api/0.2/entity/104',
                                           'relationType': 'crm:P67 refers to',
                                           'relationSystemClass': 'place',
                                           'relationDescription': 'OpenAtlas Website',
                                           'type': None, 'when': {'timespans': [
...
api_code_place_limit_sort_column_filter = {
    'results': [
        {
            '@context': 'https://raw.githubusercontent.com/LinkedPasts/linked-places/master/linkedplaces-context-v1.1.jsonld',
            'type': 'FeatureCollection', 'features': [
            {'@id': 'http://local.host/entity/110', 'type': 'Feature',
             ...
             'properties': {'title': 'Strato'}, 'description': None, 'when': {
                'timespans': [{'start': {'earliest': 'None', 'latest': 'None'},
                               'end': {'earliest': 'None', 'latest': 'None'}}]},
             'types': None, 'relations': [{'label': 'Location of Strato',
            ...
            'type': 'FeatureCollection', 'features': [
                {'@id': 'http://local.host/entity/104', 'type': 'Feature',
                 ...
                 'types': [{'identifier': 'http://local.host/api/0.2/entity/65',
                            ...
                            'hierarchy': '', 'value': None, 'unit': None}, {
                               'identifier': 'http://local.host/api/0.2/entity/102',
                               'label': 'Height', 'description': None,
                               'hierarchy': 'Dimensions', 'value': 23.0,
                               'unit': 'centimeter'}], 'relations': [
                    ...
                    {'label': 'Place',
                     'relationTo': 'http://local.host/api/0.2/entity/65',
                     'relationType': 'crm:P2 has type',
                     'relationSystemClass': 'type', 'relationDescription': None,
                     'type': None, 'when': {'timespans': [
                        {'start': {'earliest': 'None', 'latest': 'None'},
                         'end': {'earliest': 'None', 'latest': 'None'}}]}},
                    {'label': 'Datei',
                    ...
                    {'label': 'GeoNames',
                     ...
                     'relationType': 'crm:P67i is referred to by',
                     'relationSystemClass': 'reference_system',
                     'relationDescription': '2761369', 'type': 'closeMatch',
                     'when': {'timespans': [
                         {'start': {'earliest': 'None', 'latest': 'None'},
                          'end': {'earliest': 'None', 'latest': 'None'}}]}},
                    {'label': 'https://openatlas.eu',
                 ...
                 'geometry': {'type': 'Point', 'coordinates': [9, 17],
                              'title': '', 'description': ''}, 'depictions': [
                    {'@id': 'http://local.host/api/0.2/entity/112',
                     'title': 'Datei', 'license': 'Open license',
                     'url': 'N/A'}]}]}, {
            '@context': 'https://raw.githubusercontent.com/LinkedPasts/linked-places/master/linkedplaces-context-v1.1.jsonld',
            'type': 'FeatureCollection', 'features': [
            ...
            'type': 'FeatureCollection', 'features': [
                {'@id': 'http://local.host/entity/108', 'type': 'Feature',
                 ...
                 'when': {'timespans': [
                     {'start': {'earliest': 'None', 'latest': 'None'},
                      'end': {'earliest': 'None', 'latest': 'None'}}]},
                 'types': None, 'relations': [{'label': 'Location of Feature',
    ...
    'pagination': {'entities': 4, 'entitiesPerPage': 10,
                   'index': [{'page': 1, 'startId': 110}], 'totalPages': 1}}

api_code_place_filter_id = {
    'results': [
        {
            '@context': 'https://raw.githubusercontent.com/LinkedPasts/linked-places/master/linkedplaces-context-v1.1.jsonld',
            'type': 'FeatureCollection', 'features': [
    ...
    'pagination': {'entities': 3, 'entitiesPerPage': 20,
                   'index': [{'page': 1, 'startId': 108}], 'totalPages': 1}}

api_code_place_filter_time = {
    'results': [
        {
            '@context': 'https://raw.githubusercontent.com/LinkedPasts/linked-places/master/linkedplaces-context-v1.1.jsonld',
            'type': 'FeatureCollection', 'features': [
...
api_entities_linked_entity = {
    'results': [{
            ...
            {'@id': 'http://local.host/entity/112', 'type': 'Feature',
             ...
             'properties': {'title': 'Datei'}, 'description': None, 'when': {
                'timespans': [{'start': {'earliest': 'None', 'latest': 'None'},
                               'end': {'earliest': 'None', 'latest': 'None'}}]},
             'types': [{'identifier': 'http://local.host/api/0.2/entity/49',
                        'label': 'Open license', 'description': None,
                        'hierarchy': 'License', 'value': None, 'unit': None}],
            ...
            {'@id': 'http://local.host/entity/102', 'type': 'Feature',
             ...
             'description': [{'value': 'centimeter'}], 'when': {'timespans': [
                {'start': {'earliest': 'None', 'latest': 'None'},
                 'end': {'earliest': 'None', 'latest': 'None'}}]},
             'types': None, 'relations': [{'label': 'Dimensions',
            ...
            {'@id': 'http://local.host/entity/65', 'type': 'Feature',
             ...
             'when': {'timespans': [
                 {'start': {'earliest': 'None', 'latest': 'None'},
                  'end': {'earliest': 'None', 'latest': 'None'}}]},
             'types': None, 'relations': [{'label': 'Boundary Mark',
    ...
    'pagination': {'entities': 8, 'entitiesPerPage': 20,
                   'index': [{'page': 1, 'startId': 112}], 'totalPages': 1}}
