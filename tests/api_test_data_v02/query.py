        ...
        return {'results': [
            ...
            'features': [{
                ...
                'relations': [{
                    ...
                    'relationTo': f'http://local.host/api/0.2/entity/{params["location_ring_id"]}',
            ...
            'features': [{
                ...
                'relations': [{
                    'label': 'Kitchen',
                    'relationTo': f'http://local.host/api/0.2/entity/{params["kitchen_id"]}',
                    ...
                    'relationTo': f'http://local.host/api/0.2/entity/{params["location_home_id"]}',
                    'relationType': 'crm:P53 has former or current location',
                    'relationSystemClass': 'object_location',
                    'relationDescription': None,
                    'type': None,
            ...
            'features': [{
                ...
                'relations': [{
                    ...
                    'relationTo': f'http://local.host/api/0.2/entity/{params["location_kitchen_id"]}',
                    'relationType': 'crm:P53 has former or current location',
                    'relationSystemClass': 'object_location',
                    'relationDescription': None,
                    'type': None,
                    ...
                    'relationTo': f'http://local.host/api/0.2/entity/{params["home_id"]}',
                    'relationType': 'crm:P46i forms part of',
            ...
            'type': 'FeatureCollection', 'features': [{
                ...
                'when': {
                    'timespans': [{
                        ...
                        'end': {'earliest': 'None', 'latest': 'None'}}]},
                'types': [{
                    'identifier': f'http://local.host/api/0.2/entity/{params["boundary_mark_id"]}',
                ...
                'relations': [{
                    ...
                    'relationTo': f'http://local.host/api/0.2/entity/{params["location_mordor_id"]}',
                    'relationType': 'crm:P53 has former or current location',
                    'relationSystemClass': 'object_location',
                    'relationDescription': None,
                    'type': None,
            ...
            'features': [{
                ...
                'when': {
                    'timespans': [{
                        ...
                        'end': {'earliest': '2019-01-31',
                                'latest': '2019-03-01'}}]},
                'types': [{
                    'identifier': f'http://local.host/api/0.2/entity/{params["place_id"]}',
                    'label': 'Place', 'description': None, 'hierarchy': '',
                    'value': None, 'unit': None}, {
                    'identifier': f'http://local.host/api/0.2/entity/{params["height_id"]}',
                ...
                'relations': [{
                    'label': 'Height',
                    'relationTo': f'http://local.host/api/0.2/entity/{params["height_id"]}',
                    'relationType': 'crm:P2 has type',
                    'relationSystemClass': 'type',
                    ...
                    'when': {
                        'timespans': [{
                            ...
                            'end': {'earliest': 'None', 'latest': 'None'}}]}}, {
                    'label': 'Place',
                    'relationTo': f'http://local.host/api/0.2/entity/{params["place_id"]}',
                    'relationType': 'crm:P2 has type',
                    'relationSystemClass': 'type',
                    'relationDescription': None,
                    'type': None,
                    'when': {
                        'timespans': [{
                            ...
                            'end': {'earliest': 'None', 'latest': 'None'}}]}}, {
                    'label': 'Sûza',
                    'relationTo': f'http://local.host/api/0.2/entity/{params["suza_id"]}',
                    ...
                    'when': {
                        'timespans': [{
                            ...
                            'end': {'earliest': 'None', 'latest': 'None'}}]}}, {
                    'label': 'GeoNames',
                    'relationTo': f'http://local.host/api/0.2/entity/{params["geonames_id"]}',
                    'relationType': 'crm:P67i is referred to by',
                    ...
                    'relationTo': f'http://local.host/api/0.2/entity/{params["lotr_id"]}',
                    'relationType': 'crm:P67i is referred to by',
                    ...
                    'relationTo': f'http://local.host/api/0.2/entity/{params["picture_id"]}',
                    'relationType': 'crm:P67i is referred to by',
                    'relationSystemClass': 'file',
                    'relationDescription': None,
                    'type': None,
    ...
    def get_test_query_first(params):
        return {'results': [
            ...
            'pagination': {
                ...
                'entitiesPerPage': 1,
                'index': [{
                    'page': 1, 'startId': params["location_shire_id"]}, {
                    'page': 2, 'startId': params["ring_id"]}, {
                    'page': 3, 'startId': params["frodo_id"]}, {
                    'page': 4, 'startId': params["sam_id"]}, {
                    'page': 5, 'startId': params["home_id"]}, {
                    'page': 6, 'startId': params["kitchen_id"]}, {
                    'page': 7, 'startId': params["mordor_id"]}, {
                    'page': 8, 'startId': params["shire_id"]}],
                'totalPages': 8}}
