...
test_code = {'results': [{
    ...
    'features': [{
        ...
        'relations': [{
            'label': 'Kitchen',
            'relationTo':
                f'http://local.host/api/0.2/entity/{test_ids["kitchen_id"]}',
            ...
            'relationTo':
                f'http://local.host/api/0.2/entity/{test_ids["location_home_id"]}',
    ...
    'features': [
        {'@id': f'http://local.host/entity/{test_ids["kitchen_id"]}',
         ...
         'relations': [{
             ...
             'relationTo':
                 f'http://local.host/api/0.2/entity/{test_ids["location_kitchen_id"]}',
             'relationType': 'crm:P53 has former or current location',
             'relationSystemClass': 'object_location',
             'relationDescription': None,
             'type': None,
