    ...
    return {'results': [{
        ...
        'features': [{
            ...
            'relations': [{
                'label': 'Kitchen',
                'relationTo':
                    f'http://local.host/api/0.2/entity/{params["kitchen_id"]}',
                ...
                'relationTo':
                    f'http://local.host/api/0.2/entity/{params["location_home_id"]}',
        ...
        'features': [
            {'@id': f'http://local.host/entity/{params["kitchen_id"]}',
             ...
             'relations': [{
                 ...
                 'relationTo':
                     f'http://local.host/api/0.2/entity/{params["location_kitchen_id"]}',
                 'relationType': 'crm:P53 has former or current location',
                 'relationSystemClass': 'object_location',
                 'relationDescription': None,
                 'type': None,
