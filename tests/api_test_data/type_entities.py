...
def get_test_type_entities_all_special(params):
    ...
    'features': [{
        ...
        'relations': [{
            ...
            'relationTo':
                f'http://local.host/api/0.2/entity/{params["administrative_id"]}',
            ...
            'relationTo':
                f'http://local.host/api/0.2/entity/{params["nieder_id"]}',
    ...
    'type': 'FeatureCollection',
    'features': [{
        '@id': f'http://local.host/entity/{params["czech_id"]}',
        'type': 'Feature',
        'crmClass': 'crm:E53 Place',
        'systemClass': 'administrative_unit',
    ...
    'features': [{
        ...
        'relations': [{
            'label': 'Administrative unit',
            'relationTo': f'http://local.host/api/0.2/entity/{params["administrative_id"]}',
            'relationType': 'crm:P89 falls within',
            'relationSystemClass': 'administrative_unit',
            'relationDescription': None,
            'type': None,
    ...
    'type': 'FeatureCollection',
    'features': [{
        '@id': f'http://local.host/entity/{params["nieder_id"]}',
        'type': 'Feature',
        'crmClass': 'crm:E53 Place',
        'systemClass': 'administrative_unit',
