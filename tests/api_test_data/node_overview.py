        ...
        'standard': {
            'Actor actor relation': [{
                ...
                'label': 'Economical', 'children': [{
                    ...
                    'url': f'http://local.host/api/0.2/entity/{params["provider_id"]}',
                ...
                'label': 'Kindredship', 'children': [{
                    'id': params["parent_id"],
                    'url': f'http://local.host/api/0.2/entity/{params["parent_id"]}',
                ...
                'label': 'Political', 'children': [{
                    'id': params["ally_id"],
                    'url': f'http://local.host/api/0.2/entity/{params["ally_id"]}',
                    'label': 'Ally of', 'children': []}, {
                    'id': params["leader_id"],
                    'url': f'http://local.host/api/0.2/entity/{params["leader_id"]}',
                    'label': 'Leader of (Retinue of)', 'children': []}]}, {
                'id': params["social_id"],
                'url': f'http://local.host/api/0.2/entity/{params["social_id"]}',
                'label': 'Social', 'children': [{
                    'id': params["enemy_id"],
                    'url': f'http://local.host/api/0.2/entity/{params["enemy_id"]}',
                    'label': 'Enemy of', 'children': []}, {
                    'id': params["friend_id"],
                    'url': f'http://local.host/api/0.2/entity/{params["friend_id"]}',
                    'label': 'Friend of', 'children': []}, {
                    'id': params["mentor_id"],
                    'url': f'http://local.host/api/0.2/entity/{params["mentor_id"]}',
            ...
            'Event': [{
                'id': params["change_id"],
                'url': f'http://local.host/api/0.2/entity/{params["change_id"]}',
            ...
            'License': [{
                ...
                'label': 'Open license', 'children': [{
                    ...
                    'url': f'http://local.host/api/0.2/entity/{params["cc_by_sa_id"]}',
                    'label': 'CC BY-SA 4.0', 'children': []}, {
                    'id': params["cc_by_id"],
                    'url': f'http://local.host/api/0.2/entity/{params["cc_by_id"]}',
                ...
                'id': params["proprietary_id"],
                'url': f'http://local.host/api/0.2/entity/{params["proprietary_id"]}',
                'label': 'Proprietary license', 'children': []}],
            'Place': [{
                'id': params["boundary_id"],
                'url': f'http://local.host/api/0.2/entity/{params["boundary_id"]}',
                ...
                'id': params["topographical_id"],
                'url': f'http://local.host/api/0.2/entity/{params["topographical_id"]}',
            ...
            'Administrative unit': [{
                ...
                'label': 'Austria', 'children': [{
                    'id': params["nieder_id"],
                    'url': f'http://local.host/api/0.2/entity/{params["nieder_id"]}',
                    'label': 'Niederösterreich', 'children': []}, {
                    'id': params["wien_id"],
                    'url': f'http://local.host/api/0.2/entity/{params["wien_id"]}',
                    'label': 'Wien', 'children': []}]}, {
                'id': params["czech_id"],
                'url': f'http://local.host/api/0.2/entity/{params["czech_id"]}',
            ...
            'Historical place': [{
                'id': params["carantinia_id"],
                'url': f'http://local.host/api/0.2/entity/{params["carantinia_id"]}',
                'label': 'Carantania', 'children': []}, {
                'id': params["comitatus_id"],
                'url': f'http://local.host/api/0.2/entity/{params["comitatus_id"]}',
                'label': 'Comitatus Iauntal', 'children': []}, {
                'id': params["serbia_id"],
                'url': f'http://local.host/api/0.2/entity/{params["serbia_id"]}',
                'label': 'Kingdom of Serbia', 'children': []}, {
                'id': params["marcha_id"],
                'url': f'http://local.host/api/0.2/entity/{params["marcha_id"]}',
