...
test_type_tree = {'typeTree': [{
    ...
    test_ids["source_id"]: {
        ...
        'count': 0, 'count_subs': 0,
        'locked': False, 'standard': True}}, {
    test_ids["source_translation_id"]: {
